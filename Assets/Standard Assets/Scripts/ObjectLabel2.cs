/* Code taken from UnifyCommunity Website. Can be found at this URL: http://wiki.unity3d.com/index.php?title=ObjectLabel*/

using UnityEngine;
using System.Collections;

[RequireComponent(typeof(GUITexture))]
public class ObjectLabel2 : MonoBehaviour
{
